...
public class BidQA_PostNew_SkillsError {
    ...
    public void test1() throws Exception {
        ...
        Assert.assertEquals(page.getBidQAPostNew().BidQA_Error_Skills().getText(),data.strErrorSkills);
        System.out.println(page.getBidQAPostNew().BidQA_Error_Skills().getText());
