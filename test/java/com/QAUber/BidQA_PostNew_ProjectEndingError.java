...
public class BidQA_PostNew_ProjectEndingError {
    ...
    public void test1() throws Exception {
        ...
        Assert.assertEquals(page.getBidQAPostNew().BidQA_Error_ProjectEnding().getText(),data.strErrorProjectEnd);
        System.out.println(page.getBidQAPostNew().BidQA_Error_ProjectEnding().getText());
